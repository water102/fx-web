import { isNilOrEmpty, isNotNilAndEmpty, trim, } from "@water102/fx-common";
 ...
 * }, {});
 */
export function addGlobalEventListener(type, selector, callback, options = false, parent = document) {
 ...
 */
export function $setValue(element, value, isHtml = false) {
 ...
 */
export function $getValue(element, isHtml = false) {
    switch (element.tagName) {
        case "INPUT":
        case "TEXTAREA":
 ...
 */
export function $name(name, parent = document) {
